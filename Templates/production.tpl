...
<table id="production" cellpadding="1" cellspacing="1">
	...
	<tr>
		...
		<td class="num"><?php echo number_format_short($village->getProd("wood")); ?></td>
	...
	<tr>
		...
		<td class="num"><?php echo number_format_short($village->getProd("clay")); ?></td>
		<td class="per"><?php echo PER_HR; ?></td>
	</tr>
	...
	<tr>
		...
		<td class="num"><?php echo number_format_short($village->getProd("iron")); ?></td>
		<td class="per"><?php echo PER_HR; ?></td>
	</tr>
	...
	<tr>
		...
		<td class="num"><?php echo number_format_short($village->getProd("crop")); ?></td>
		<td class="per"><?php echo PER_HR; ?></td>
	</tr>
		</tbody>	
</table>