...
<form method="POST" name="snd" action="a2b.php"><input name="timestamp" value="3278280730" type="hidden"> <input name="timestamp_checksum" value="597fa8" type="hidden"> <input name="b" value="1" type="hidden">
	...
	<tbody><tr>
        ...
        if ($village->unitarray['u31']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t1.value=".$village->unitarray['u31']."; return false;\">(".number_format_short($village->unitarray['u31']).")</a></td>";
        }else{ 
        ...
        if ($village->unitarray['u34']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t4.value=".$village->unitarray['u34']."; return false;\">(".number_format_short($village->unitarray['u34']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u37']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t7.value=".$village->unitarray['u37']."; return false;\">(".number_format_short($village->unitarray['u37']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u39']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t9.value=".$village->unitarray['u39']."; return false;\">(".number_format_short($village->unitarray['u39']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
	...
	<tr>
        ...
        if ($village->unitarray['u32']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t2.value=".$village->unitarray['u32']."; return false;\">(".number_format_short($village->unitarray['u32']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u35']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t5.value=".$village->unitarray['u35']."; return false;\">(".number_format_short($village->unitarray['u35']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u38']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t8.value=".$village->unitarray['u38']."; return false;\">(".number_format_short($village->unitarray['u38']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u40']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t10.value=".$village->unitarray['u40']."; return false;\">(".number_format_short($village->unitarray['u40']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
	...
	<tr>
        ...
        if ($village->unitarray['u33']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t3.value=".$village->unitarray['u33']."; return false;\">(".number_format_short($village->unitarray['u33']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
        ...
        if ($village->unitarray['u36']>0){
        	echo "<a href=\"#\" onclick=\"document.snd.t6.value=".$village->unitarray['u36']."; return false;\">(".number_format_short($village->unitarray['u36']).")</a></td>";
        }else{ 
       		echo  "<span class=\"none\">(0)</span></td>";
		}
        ?>
